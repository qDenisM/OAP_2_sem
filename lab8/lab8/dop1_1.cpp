...
int main()
{
    ...
    while (choice != 0)
    {
        ...
        case 6: cout << "Введите элемент:  "; cin >> z;
            insertToPriorityQueue(z, true); printQueue();  break;
        case 7: getFromPriorityQueue(true); break;
        case 8: cout << "Введите элемент:  "; cin >> z;
            insertToPriorityQueue(z, false); printQueue();  break;
        case 9: getFromPriorityQueue(false); break;
        }
    }
    return 0;
}
